<template>
    <div class="flex column uploadContainer">
        <div style="align-self: center;">
            ...
            >
                ...
                <div class="el-upload__tip" slot="tip">请以压缩格式上传文件</div>
            </el-upload>
        </div>
        <el-divider v-if="showFlag" content-position="left" >进度</el-divider>
        <div class="flex1" v-if="showFlag" style=" align-self: center;
    overflow-y: auto;">
        ...
        <div style="align-self: flex-end;">
            <button class="btn btnSize blue_btn" @click="handleUpload">上传</button>
            <button class="btn btnSize purple_btn" @click="handleResume" v-if="status === Status.pause">恢复</button>
            <button
                    class="btn btnSize purple_btn"
                    v-else
